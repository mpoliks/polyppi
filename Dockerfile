...
COPY sync_scheduler.py /usr/local/bin/sync_scheduler.py

# Set executable permissions
RUN chmod +x /usr/local/bin/audio_fw.py /usr/local/bin/sync_to_gcp.sh /usr/local/bin/startup.sh /usr/local/bin/monitor_docker.sh /usr/local/bin/sync_config.py /usr/local/bin/sync_scheduler.py
